...
class ProductController extends Controller
{
    ...
    {
        $all_foods = DB :: table('products')
                     ->join('categories','products.category_id','=','categories.category_id')
                     ->select('products.*','categories.category_name')
                     ->paginate(10);
        return view('admin.all_products') -> with('all_foods',$all_foods);
    }
    ...
    public function edit_product($menu_id)
    {
        ...
        return view('admin.edit_product',['food_info' => $food_info,'categories' => $categories]);
    }
    ...
    public function get_single_product($product_id)
    {
        ...
        $related_items = DB :: table('products')
                        ...
                        ->get();
        return view('single_product',['food' => $product,'related_items' => $related_items]);
    }
