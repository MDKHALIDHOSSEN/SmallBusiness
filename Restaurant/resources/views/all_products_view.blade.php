                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 15rem;">
                            <img src="{{ URL :: to($food -> item_image) }}" class="card-inside">
                            <div class="book-info">
                                <h5>{{ $food -> item_name }}</h5>
                                <h6><span class="price">Tk. {{ $food -> item_price }}</span></h6>

                            </div>
                            <a class="btn btn-outline-success" href="{{ URL :: to('/show-product/'.$food -> menu_id) }}">View details</a>
